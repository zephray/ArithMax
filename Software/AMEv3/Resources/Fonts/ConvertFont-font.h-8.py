...
def main():
    ...
    sys.stdout.write('''
 */
#ifndef __FONT_H_FONT_8
#define __FONT_H_FONT_8
/* This file is generated automatically by ConvertFont-font.h-8.py, do not edit it. */
const unsigned char asc2_0806[96][6] = {
''')
    while True:
...
def output_char(bitmap, charenc, f):
    ...
    readable = ','.join(map(lambda line: '0x%02x' % line, arranged))
